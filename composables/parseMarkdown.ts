  ...
  renderer.code = (code, language, isEscaped) => {
    ...
    switch (language) {
      ...
      case "youtube":
        ...
        ret = `<div class="youtube-thumbnail-wrapper"><img class="youtube-thumbnail" data-bs-toggle="modal" data-bs-target="#${modalIdInnerSlug}" src="${`https://img.youtube.com/vi/${youtubeId}/${
          true ? "0" : "default"
        }.jpg`}"></div>`;
        break;
      case "drive":
